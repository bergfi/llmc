...
public:
    ProcessStack(LLDMCModelGenerator* gen)
    : gen(gen)
    ...
    void pushStackFrame(GenerationContext* gctx, FunctionType* FType, Value* location, std::vector<Value*> const& args, CallInst* callSite, Value* targetThreadID = nullptr);
